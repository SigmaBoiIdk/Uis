...
--
local Page = Window:Page({Name = "Legit"})
...
--
local Silent,SAdv = Page:MultiSection({Zindex = 2, Sections = {"Silent Aim","Advanced"}})
local Aim,AAdv = Page:MultiSection({Zindex = 2, Sections = {"Aimbot","Advanced"}, Side = "Right"})
local Movement = Page:Section({Name = "Movement"})
local Mods = Page:Section({Name = "Gun Mods", Side = "Right"})
--
Players:Section({Name = "Section"})
--
Silent:Toggle({Name = "Enabled", Callback = function(state) Library.KeyList:SetVisible(state) end})
Silent:Slider({Name = "Field Of View", Min = 0, Max = 500, Default = 250})
local FOV = Silent:Toggle({Name = "Draw FOV"})
FOV:Colorpicker({})
FOV:Colorpicker({})
Silent:Toggle({Name = "Wall Check"})
Silent:List({Name = "Prediction Type", Options = {"Auto","Manual"}, Default = "Auto"})
Silent:Toggle({Name = "Closest Part"})
Silent:List({Name = "Aim Part", Options = Bodyparts, Default = "Head", ScrollingMax = 4})
Silent:Slider({Name = "Custom Prediction", Min = 0, Max = 500, Default = 0})
--
Aim:Toggle({Name = "Enabled"}):Keybind({Name = "Aimbot", Default = Enum.UserInputType.MouseButton2})
Aim:Toggle({Name = "Cam Mode"})
Aim:Textbox({Name = "Textbox"})
Aim:Button({Name = "Button"})
Aim:Keybind({Name = "Cool", Default = Enum.KeyCode.E})
--
Players:PlayerList({})
--
do -- Settings
	...
	--
	CFG:Keybind({Name = "Menu Key", Flag = "MenuKey", Ignore = true, UseKey = true, Default = Enum.KeyCode.End, Callback = function(State) Library.UIKey = State end})
